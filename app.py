...
# -----------------------------
try:
    # ★★★ ここに、新しく取得したキーとIDを設定してください ★★★
    GEMINI_API_KEY = "AIzaSyBJ9fE9_4cnQ_g0G6V1qW78giE90P272U8"
    SEARCH_API_KEY = "AIzaSyDxpcfc5dMX6eieGIAC2896RxO8Ui7JUjo"
    SEARCH_ENGINE_ID = "f2b1c77be6aa44316"
